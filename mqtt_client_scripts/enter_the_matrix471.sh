...
# mosquitto_pub -h gopher.phynetlab.com -p 8883 -m '{"id":24, "data":[11.0, 2.0, 1.4]}' -t crazyflie/start
mosquitto_pub -h gopher.phynetlab.com -p 8883 -m '{"id":26, "data":[11.0, 2.0, 1.4]}' -t crazyflie/start
# mosquitto_pub -h gopher.phynetlab.com -p 8883 -m '{"id":28, "data":[11.0, 2.0, 1.4]}' -t crazyflie/start
...
# mosquitto_pub -h gopher.phynetlab.com -p 8883 -m '{"id":24, "data": [13.0, 9.0, [1.0, -0.5, 1.4], 0.0] }' -t crazyflie/moveto
mosquitto_pub -h gopher.phynetlab.com -p 8883 -m '{"id":26, "data": [13.0, 9.0, [-0.5, -0.5, 1.4], 0.0] }' -t crazyflie/moveto
# mosquitto_pub -h gopher.phynetlab.com -p 8883 -m '{"id":28, "data": [13.0, 9.0, [-2.0, -0.5, 1.4], 0.0] }' -t crazyflie/moveto
