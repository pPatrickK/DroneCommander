...
mosquitto_pub -h gopher.phynetlab.com -p 8883 -m '{"id":27, "data": [33.0, 9.0] }' -t crazyflie/movehome
...
mosquitto_pub -h gopher.phynetlab.com -p 8883 -m '{"id":27, "data":[42.0, 1.8, 0.4]}' -t crazyflie/landwithheight
